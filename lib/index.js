...
var compile = _commander2['default'].description('Generate models').command('compile <file>').option('-t, --template <template>').option('-c, --concat [filename]').option('-o, --out <path>');
